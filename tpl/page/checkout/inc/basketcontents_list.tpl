                        ...
                        [{block name="checkout_basketcontents_basketitem_quantity"}]
                            ...
                            <div class="quantity">
                                [{if $editable}]
                                    ...
                                    [{else}]
                                        <div class="input-group input-group-sm justify-content-end">
                                            <input id="am_[{$smarty.foreach.basketContents.iteration}]" type="number" class="textbox form-control text-center" name="aproducts[[{$basketindex}]][am]" value="[{$basketitem->getAmount()}]" size="3" min="0" style="width:60px;float:right;" readonly>
                                            <span class="input-group-append">
                                                <span class="input-group-text">
                                                    [{if $basketitem->oxarticles__oxunitname->value}]
                                                        [{$basketitem->oxarticles__oxunitname->value}]
